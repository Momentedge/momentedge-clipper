# Local ROS2 interface package defining the momentedge Trigger/Recorded event
...
ros.buildRosPackage {
  ...
  meta.description = "clipper Trigger/Recorded event interfaces";
}
