...
| `clipper_bin` | `clipper` | clipper executable, run as `<clipper_bin> tail`; set to `./target/release/clipper` for a dev build (build it with `--features ros`, or it has no ROS trigger interface — see the [README](../../README.md#from-source)) |
